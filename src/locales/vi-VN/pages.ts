export default {
  'pages.layouts.userLayout.title': 'DefZone.Net là nền tảng chia sẻ thông tin giải trí trực tuyến',
  'pages.login.accountLogin.tab': 'Email',
  'pages.login.accountLogin.errorMessage': 'Incorrect username/password(admin/ant.design)',
  'pages.login.failure': 'Login failed, please try again!',
  'pages.login.success': 'Đăng nhập thành công!',
  'pages.login.username.placeholder': 'Địa chỉ email',
  'pages.login.username.required': 'Vui lòng nhập địa chỉ email!',
  'pages.login.password.placeholder': 'Mật khẩu',
  'pages.login.password.required': 'Vui lòng nhập mật khẩu!',
  'pages.login.phoneLogin.tab': 'Điện thoại',
